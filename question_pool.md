...
- 气体探测器
  - 气体电离室
  - <img src="https://render.githubusercontent.com/render/math?math=\text{BF}_3"> 正比计数管
- 闪烁体探测器
  - NaI(Tl) 闪烁体
  - BGO 闪烁体
- 半导体探测器
...
- 省略了《核辐射探测器》P17-18 页中的 “探测和测量脉冲辐射束的探测器”、“辐射成像探测器”、“超导探测器” 等。因为这些类别下没有列出具体的探测器，大概不在考试要求内。
